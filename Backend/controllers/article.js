...
const { params, put, param } = require("../routes/article");
...
var controller =  {
        ...
        query.sort('-_id').exec((err, articles) => {
            ...
            if(err){
                return res.status(500).send({
                    status: 'error',
                    message :  'Error al devolver los artuclos !!!'
                });
            }
    ...
    upload : (req, res) => {
        ...
        if (file_ext != 'png' && file_ext != 'jpg' && file_ext != 'jpeg' && file_ext != 'gih') {
            //Borrar el archivo suvido
